                ...
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-grey-200 dark:border-gray-800">
                    <table class="text-center w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-lighter">
                                <td class="py-4 px-6 border-b border-gray-light dark:border-gray-600" style="background-image: linear-gradient(to left, rgba(173, 216, 230, 0.5), rgba(173, 216, 230, 0.3) 100%, white 100%)">
